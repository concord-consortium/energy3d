...
public class ArdorMeshMapper
{
    ...
    public static void updateTriangleMesh( final Mesh mesh,
                                           final List<DelaunayTriangle> triangles )
    {
                                           ...
                                           final CoordinateTransform pc )
    {
        ...
        final int size = 3*3*triangles.size();
        prepareVertexBuffer( mesh, size );

        vertBuf = mesh.getMeshData().getVertexBuffer();
        vertBuf.rewind();
        for( final DelaunayTriangle t : triangles )
        {
            for( int i=0; i<3; i++ )
            {
    ...
    public static void updateFaceNormals( final Mesh mesh,
                                            final List<DelaunayTriangle> triangles )
    {
    ...
    public static void updateVertexNormals( final Mesh mesh,
                                            final List<DelaunayTriangle> triangles )
    {
                                            ...
                                            final CoordinateTransform pc )
    {
        ...
        HashMap<DelaunayTriangle,Vector3> fnMap;
        final HashMap<TriangulationPoint,Vector3> vnMap = new HashMap<TriangulationPoint,Vector3>(3*triangles.size());
        final int size = 3*3*triangles.size();
        ...
        for( final Vector3 normal : vnMap.values() )
        {
    ...
    private static HashMap<DelaunayTriangle,Vector3> calculateFaceNormals( final List<DelaunayTriangle> triangles,
                                                                          final CoordinateTransform pc )
    {
        final HashMap<DelaunayTriangle,Vector3> normals = new HashMap<DelaunayTriangle,Vector3>(triangles.size());
        final TPoint point = new TPoint(0,0,0);
     ...
     * @param scale
     */
    public static void updateTextureCoordinates( final Mesh mesh,
                                                 final List<DelaunayTriangle> triangles,
                                                 final double scale,
                                                 final double angle )
    {
...
//    }
    ...
    public static void updateTriangleMesh( final Mesh mesh, final PointSet ps, final CoordinateTransform pc )
    {
     ...
     * @param ps
     */
    public static void updateTriangleMesh( final Mesh mesh, final PointSet ps )
    {
        updateTriangleMesh( mesh, ps.getTriangles() );
    }

    public static void updateTriangleMesh( final Mesh mesh, final Polygon p )
    {
        updateTriangleMesh( mesh, p.getTriangles() );
    }

    public static void updateTriangleMesh( final Mesh mesh, final Polygon p, final CoordinateTransform pc )
    {
        updateTriangleMesh( mesh, p.getTriangles(), pc );
    }

    public static void updateVertexBuffer( final Mesh mesh, final List<? extends Point> list )
    {
        FloatBuffer vertBuf;
    ...
    public static void updateIndexBuffer( final Mesh mesh, final int[] index )
    {
//        IntBuffer indexBuf;
//
...
//        }
    ...
    private static void prepareVertexBuffer( final Mesh mesh, final int size )
    {
        FloatBuffer vertBuf;
    ...
    private static void prepareNormalBuffer( final Mesh mesh, final int size )
    {
        FloatBuffer nBuf;
    ...
    private static void prepareIndexBuffer( final Mesh mesh, final int size)
    {
...
//        }
    ...
    private static FloatBuffer prepareTextureCoordinateBuffer( final Mesh mesh, final int index, final int size )
    {
        FloatBuffer tcBuf;
