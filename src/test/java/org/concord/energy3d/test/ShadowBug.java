...
maxHeapMemory = 64)
public class ShadowBug extends ExampleBase {
    ...
    public static void main(final String[] args) {
    	MainApplication.setupLibraryPath();
        start(ShadowBug.class);
    }
...
//        textNodes.getSceneHints().setRenderBucketType(RenderBucketType.Ortho);
        ...
        for (int i = 0; i < _exampleInfo.length; i++) {
            ...
            _exampleInfo[i].getSceneHints().setRenderBucketType(RenderBucketType.PostBucket);
