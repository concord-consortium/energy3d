...
public class ChangeBuildingSolarCellEfficiencyCommand extends AbstractUndoableEdit {
	...
	public ChangeBuildingSolarCellEfficiencyCommand(Foundation foundation) {
