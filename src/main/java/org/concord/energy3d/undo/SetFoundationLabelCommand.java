...
public class SetFoundationLabelCommand extends MyAbstractUndoableEdit {
    ...
    public SetFoundationLabelCommand(final Foundation foundation) {
        ...
        oldLabelCustom = foundation.getLabelCustom();
    ...
    public void undo() throws CannotUndoException {
        ...
        newLabelCustom = foundation.getLabelCustom();
        ...
        foundation.setLabelCustom(oldLabelCustom);
    ...
    public void redo() throws CannotRedoException {
        ...
        foundation.setLabelCustom(newLabelCustom);
