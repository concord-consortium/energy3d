...
public class ChangeFoundationParabolicTroughReflectivityCommand extends AbstractUndoableEdit {
	...
	public ChangeFoundationParabolicTroughReflectivityCommand(final Foundation foundation) {
	...
	public String getPresentationName() {
		return "Reflectivity Change for All Parabolic Troughs on Selected Foundation";
	}
