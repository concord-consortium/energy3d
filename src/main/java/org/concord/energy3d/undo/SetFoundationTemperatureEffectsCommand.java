...
public class SetFoundationTemperatureEffectsCommand extends AbstractUndoableEditWithTimestamp {
	...
	public SetFoundationTemperatureEffectsCommand(final Foundation foundation) {
