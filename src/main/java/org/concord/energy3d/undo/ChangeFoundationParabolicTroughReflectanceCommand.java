...
public class ChangeFoundationParabolicTroughReflectanceCommand extends AbstractUndoableEditWithTimestamp {
	...
	public ChangeFoundationParabolicTroughReflectanceCommand(final Foundation foundation) {
	...
	public String getPresentationName() {
		return "Reflectance Change for All Parabolic Troughs on Selected Foundation";
	}
