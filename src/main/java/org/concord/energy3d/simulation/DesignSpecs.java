...
public class DesignSpecs implements Serializable {
    ...
    public void setBudgetEnabled(final boolean budgetEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingCostGraph().updateBudget());
    }
    ...
    public void setNumberOfWindowsEnabled(final boolean numberOfWindowsEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingInfoPanel().updateWindowNumberBounds());
    }
    ...
    public void setNumberOfSolarPanelsEnabled(final boolean numberOfSolarPanelsEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingInfoPanel().updateSolarPanelNumberBounds());
    }
    ...
    public void setWindowToFloorRatioEnabled(final boolean windowToFloorRatioEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingInfoPanel().updateWindowToFloorRatioBounds());
    }
    ...
    public void setHeightEnabled(final boolean heightEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingInfoPanel().updateHeightBounds());
    }
    ...
    public void setAreaEnabled(final boolean areaEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingInfoPanel().updateAreaBounds());
    }
    ...
    public void setNumberOfWallsEnabled(final boolean numberOfWallsEnabled) {
        ...
        EventQueue.invokeLater(() -> EnergyPanel.getInstance().getBuildingInfoPanel().updateWallNumberBounds());
    }
