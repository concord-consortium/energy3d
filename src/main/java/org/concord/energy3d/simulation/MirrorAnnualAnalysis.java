			...
			public Object call() {
				EventQueue.invokeLater(new Runnable() {
					...
					public void run() {
						...
						JOptionPane.showMessageDialog(parent, "<html>The calculated annual output is <b>" + current + " kWh</b>." + (previousRuns.equals("") ? "" : "<br>For details, look at the graph.<br><br><hr>Results from all previously recorded tests:<br>" + previousRuns) + "</html>", "Annual Output", JOptionPane.INFORMATION_MESSAGE);
					}
