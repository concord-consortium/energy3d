...
public class FresnelReflector extends HousePart implements SolarReflector, Labelable {
    ...
    protected void drawMesh() {
        ...
        double baseZ = container instanceof Foundation ? container.getHeight() : container.getPoints().get(0).getZ();
        ...
        if (absorber != null) {
            ...
            final double shift = sunDirection.getZ() < MathUtils.ZERO_TOLERANCE ? 0 : (center.getZ() - absorberCenter.getZ()) * (sunDirection.getY() * rotationAxis.getY()
                    + sunDirection.getX() * rotationAxis.getX()) / sunDirection.getZ();
    ...
    public void drawSunBeam() {
        ...
        final double shift = sunDirection.getZ() < MathUtils.ZERO_TOLERANCE ? 0 : (o.getZ() - c.getZ()) * (sunDirection.getY() * rotationAxis.getY()
                + sunDirection.getX() * rotationAxis.getX()) / sunDirection.getZ();
