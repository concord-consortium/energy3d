...
public class Paraboloid extends Mesh {
     ...
     *
     * @param name      Name of paraboloid.
     * @param rimRadius The radius of the paraboloid rim.
     * @param a         parameter a of the round paraboloid, related to the focal length(f) by a = 2 * sqrt(f).
     * @param zSamples  The samples along the axis.
     * @param rSamples  The samples along the radial.
     */
     ...
     *
     * @param rimRadius The rim radius of the paraboloid.
     * @param a         curvature parameter a of the paraboloid.
     * @param zSamples  The new number of zSamples of the paraboloid.
     * @param rSamples  The new number of radial samples of the paraboloid.
     */
