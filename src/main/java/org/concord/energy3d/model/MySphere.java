...
public class MySphere extends Mesh {
	 ...
	 */
	public MySphere(final String name, final ReadOnlyVector3 center, final int zSamples, final int radialSamples, final double radius, final TextureMode textureMode) {
		super(name);
	...
	/**
	 * 
	 * @return true if the normals are inverted to point into the sphere so that the face is oriented for a viewer inside the sphere. false (the default) for exterior viewing.
	 */
