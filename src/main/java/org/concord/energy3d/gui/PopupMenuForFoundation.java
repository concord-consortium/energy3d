...
class PopupMenuForFoundation extends PopupMenuFactory {
	...
	static JPopupMenu getPopupMenu(final MouseEvent e) {
		...
		if (popupMenuForFoundation == null) {
						...
						if (choice == options[1] || choice == null) {
							...
							if (ok) {
								if (populationSize <= 0) {
									...
									final BuildingLocationOptimizer op = new BuildingLocationOptimizer(populationSize, 2, selectedSelectionMethod, convergenceThreshold, 30);
			...
			miBuildingOrientation.addActionListener(new ActionListener() {
						...
						if (choice == options[1] || choice == null) {
							...
							if (ok) {
								if (populationSize <= 0) {
									...
									selectedFitnessFunction = fitnessComboBox.getSelectedIndex();
									selectedSelectionMethod = selectionComboBox.getSelectedIndex();
									final BuildingOrientationOptimizer op = new BuildingOrientationOptimizer(populationSize, 2, selectedSelectionMethod, convergenceThreshold, 30);
									op.setMaximumGenerations(maximumGenerations);
									op.setMutationRate(mutationRate);
									op.setFoundation(foundation);
									op.setOjectiveFunction(selectedFitnessFunction);
			...
			miSolarPanelTiltAngle.addActionListener(new ActionListener() {
			...
			miSolarArray.addActionListener(new ActionListener() {
			...
			miHeliostatPositions.addActionListener(new ActionListener() {
						...
						if (choice == options[1] || choice == null) {
							...
							if (ok) {
								if (populationSize <= 0) {
									...
									selectedFitnessFunction = fitnessComboBox.getSelectedIndex();
									selectedSelectionMethod = selectionComboBox.getSelectedIndex();
									final HeliostatPositionOptimizer op = new HeliostatPositionOptimizer(populationSize, foundation.getHeliostats().size() * 2, selectedSelectionMethod, convergenceThreshold, 0);
									op.setMaximumGenerations(maximumGenerations);
									op.setMutationRate(mutationRate);
									op.setOjectiveFunction(selectedFitnessFunction);
									op.setFoundation(foundation);
			...
			miHeliostatConcentricField.addActionListener(new ActionListener() {
						...
						if (choice == options[1] || choice == null) {
							...
							if (ok) {
								if (populationSize <= 0) {
									...
									selectedFitnessFunction = fitnessComboBox.getSelectedIndex();
									selectedSelectionMethod = selectionComboBox.getSelectedIndex();
									final HeliostatConcentricFieldOptimizer op = new HeliostatConcentricFieldOptimizer(populationSize, foundation.getHeliostats().size() * 2, selectedSelectionMethod, convergenceThreshold, 0);
			...
			miHeliostatSpiralField.addActionListener(new ActionListener() {
						...
						if (choice == options[1] || choice == null) {
							...
							if (ok) {
								if (populationSize <= 0) {
									...
									selectedFitnessFunction = fitnessComboBox.getSelectedIndex();
									selectedSelectionMethod = selectionComboBox.getSelectedIndex();
									final HeliostatSpiralFieldOptimizer op = new HeliostatSpiralFieldOptimizer(populationSize, foundation.getHeliostats().size() * 2, selectedSelectionMethod, convergenceThreshold, 0);
