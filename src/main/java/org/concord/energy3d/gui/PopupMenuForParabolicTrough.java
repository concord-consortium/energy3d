                                ...
                                if (nSectionParabola < 4) {
                                    ...
                                    if (rb1.isSelected()) {
                                        ...
                                        SceneManager.getTaskManager().update(() -> {
                                            t.setNSectionParabola(nSectionParabola2);
                                            t.setNSectionAxis(nSectionAxis2);
                                            t.draw();
                                        ...
                                        SceneManager.getTaskManager().update(() -> {
                                            foundation.setSectionsForParabolicTroughs(nSectionParabola2, nSectionAxis2);
                                            return null;
                                        });
                                        // SceneManager.getInstance().getUndoManager().addEdit(c);
                                        ...
                                        SceneManager.getTaskManager().update(() -> {
                                            Scene.getInstance().setSectionsForAllParabolicTroughs(nSectionParabola2, nSectionAxis2);
                                            return null;
                                        });
                                        // SceneManager.getInstance().getUndoManager().addEdit(c);
                                ...
                                if (l < 1 || l > 1000) {
                                    ...
                                    if (rb1.isSelected()) {
                                        ...
                                        if (changed) {
                                            final SetShapeForParabolicTroughsOnFoundationCommand c = new SetShapeForParabolicTroughsOnFoundationCommand(foundation);
                                            SceneManager.getTaskManager().update(() -> {
                                                foundation.setLengthForParabolicTroughs(l2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                        ...
                                        if (changed) {
                                            final SetShapeForAllParabolicTroughsCommand c = new SetShapeForAllParabolicTroughsCommand();
                                            SceneManager.getTaskManager().update(() -> {
                                                Scene.getInstance().setLengthForAllParabolicTroughs(l2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                ...
                                if (w < 1 || w > 20) {
                                    ...
                                    if (rb1.isSelected()) {
                                        ...
                                        if (changed) {
                                            final SetShapeForParabolicTroughsOnFoundationCommand c = new SetShapeForParabolicTroughsOnFoundationCommand(foundation);
                                            SceneManager.getTaskManager().update(() -> {
                                                foundation.setApertureForParabolicTroughs(w2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                        ...
                                        if (changed) {
                                            final SetShapeForAllParabolicTroughsCommand c = new SetShapeForAllParabolicTroughsCommand();
                                            SceneManager.getTaskManager().update(() -> {
                                                Scene.getInstance().setApertureForAllParabolicTroughs(w2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                ...
                                if (u < 1 || u > 100) {
                                    ...
                                    if (rb1.isSelected()) {
                                        ...
                                        if (changed) {
                                            final SetShapeForParabolicTroughsOnFoundationCommand c = new SetShapeForParabolicTroughsOnFoundationCommand(foundation);
                                            SceneManager.getTaskManager().update(() -> {
                                                foundation.setModuleLengthForParabolicTroughs(u2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                        ...
                                        if (changed) {
                                            final SetShapeForAllParabolicTroughsCommand c = new SetShapeForAllParabolicTroughsCommand();
                                            SceneManager.getTaskManager().update(() -> {
                                                Scene.getInstance().setModuleLengthForAllParabolicTroughs(u2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                ...
                                if (f < 0.5 || f > 5) {
                                    ...
                                    if (rb1.isSelected()) {
                                        if (changed) {
                                            ...
                                            SceneManager.getTaskManager().update(() -> {
                                                t.setSemilatusRectum(2 * f2); // semilatus rectum p = 2f
                                                t.draw();
                                                SceneManager.getInstance().refresh();
                                                return null;
                                            });
                                        ...
                                        if (changed) {
                                            final SetShapeForParabolicTroughsOnFoundationCommand c = new SetShapeForParabolicTroughsOnFoundationCommand(foundation);
                                            SceneManager.getTaskManager().update(() -> {
                                                foundation.setSemilatusRectumForParabolicTroughs(2 * f2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                        ...
                                        if (changed) {
                                            final SetShapeForAllParabolicTroughsCommand c = new SetShapeForAllParabolicTroughsCommand();
                                            SceneManager.getTaskManager().update(() -> {
                                                Scene.getInstance().setSemilatusRectumForAllParabolicTroughs(2 * f2);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                ...
                                if (val < 0 || val * Scene.getInstance().getScale() > 10) {
                                    ...
                                    if (rb1.isSelected()) {
                                        ...
                                        if (changed) {
                                            ...
                                            SceneManager.getTaskManager().update(() -> {
                                                foundation.setPoleHeightForSolarCollectors(poleHeight, t.getClass());
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                                        ...
                                        if (changed) {
                                            ...
                                            SceneManager.getTaskManager().update(() -> {
                                                Scene.getInstance().setPoleHeightForAllParabolicTroughs(poleHeight);
                                                return null;
                                            });
                                            SceneManager.getInstance().getUndoManager().addEdit(c);
                                        }
                            ...
                            if (ok) {
                                ...
                                if (rb1.isSelected()) {
                                    if (changed) {
                                        ...
                                        SceneManager.getTaskManager().update(() -> {
                                            trough.setRelativeAzimuth(azimuth);
                                            trough.draw();
                                            SceneManager.getInstance().refresh();
                                            return null;
                                        });
                                    ...
                                    if (changed) {
                                        ...
                                        SceneManager.getTaskManager().update(() -> {
                                            foundation.setAzimuthForParabolicTroughs(azimuth);
                                            return null;
                                        });
                                        SceneManager.getInstance().getUndoManager().addEdit(c);
                                    }
                                    ...
                                    if (changed) {
                                        ...
                                        SceneManager.getTaskManager().update(() -> {
                                            Scene.getInstance().setAzimuthForAllParabolicTroughs(azimuth);
                                            return null;
                                        });
                                        SceneManager.getInstance().getUndoManager().addEdit(c);
                                    }
