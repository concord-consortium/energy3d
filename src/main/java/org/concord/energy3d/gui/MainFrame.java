...
public class MainFrame extends JFrame {
	...
	private JDialog getAboutDialog() {
		if (aboutDialog == null) {
			...
			p.add(new JLabel("<html><h1>Energy3D</h1><h3><i>Learning to build a sustainable world</i></h3><br>Version: " + MainApplication.VERSION + ", Copyright 2011-" + Calendar.getInstance().get(Calendar.YEAR) + "<br>The Engineering Computation Laboratory, Concord Consortium<hr><h3>Credit:</h3>This program is brought to you by:<ul><li>Dr. Charles Xie (2010-present) <li>Dr. Saeid Nourian (2010-2017)</ul><p>and the people who created Ardor3D, Getdown, JOGL, and Poly2tri.<br><br>This program is provided to you as it is under the MIT License. Funding is provided<br>by the National Science Foundation through grants 0918449, 1304485, 1348530,<br>1503196, 1512868, and 1721054 and by General Motors through grant 34871079.<br>Any opinions, findings, and conclusions or recommendations expressed in the materials<br>associated with this program are those of the author(s) and do not necessarily reflect<br>the views of the National Science Foundation or General Motors.</html>"), BorderLayout.CENTER);
