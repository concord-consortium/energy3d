...
public class HeliostatConcentricFieldOptimizer extends HeliostatFieldOptimizer {
    ...
    HeliostatConcentricFieldOptimizer(final int populationSize, final int chromosomeLength, final int discretizationSteps) {
    ...
    void setMinimumAzimuthalSpacing(final double minimumAzimuthalSpacing) {
        this.minimumAzimuthalSpacing = minimumAzimuthalSpacing;
    }

    void setMaximumAzimuthalSpacing(final double maximumAzimuthalSpacing) {
        this.maximumAzimuthalSpacing = maximumAzimuthalSpacing;
    }

    void setMinimumRadialSpacing(final double minimumRadialSpacing) {
        this.minimumRadialSpacing = minimumRadialSpacing;
    }

    void setMaximumRadialSpacing(final double maximumRadialSpacing) {
