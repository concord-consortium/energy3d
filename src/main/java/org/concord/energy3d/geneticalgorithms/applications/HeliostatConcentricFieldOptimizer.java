 ...
 *
 */
public class HeliostatConcentricFieldOptimizer extends SolarOutputOptimizer {
	...
	public void applyFittest() {
		...
		layout.setAzimuthalSpacing(minimumAzimuthalSpacing + best.getGene(2) * (maximumAzimuthalSpacing - minimumAzimuthalSpacing));
		layout.setRadialSpacing(minimumRadialSpacing + best.getGene(3) * (maximumRadialSpacing - minimumRadialSpacing));
		layout.setRadialExpansionRatio(minimumRadialExpansion + best.getGene(4) * (maximumRadialExpansion - minimumRadialExpansion));
		foundation.generateHeliostatField(layout);
