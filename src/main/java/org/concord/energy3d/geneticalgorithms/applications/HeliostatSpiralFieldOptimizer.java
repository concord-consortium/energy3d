...
public class HeliostatSpiralFieldOptimizer extends HeliostatFieldOptimizer {
    ...
    HeliostatSpiralFieldOptimizer(final int populationSize, final int chromosomeLength, final int discretizationSteps) {
    ...
    void setMinimumDivergenceAngle(final double minimumDivergenceAngle) {
        this.minimumDivergenceAngle = minimumDivergenceAngle;
    }

    void setMaximumDivergenceAngle(final double maximumDivergenceAngle) {
