...
public class BuildingOrientationOptimizerMaker extends OptimizerMaker {
	...
	public BuildingOrientationOptimizerMaker(final Foundation foundation) {
			...
			if (choice == options[1] || choice == null) {
				...
				if (ok) {
					if (populationSize <= 0) {
						...
						final BuildingOrientationOptimizer op = new BuildingOrientationOptimizer(populationSize, 2, 30);
