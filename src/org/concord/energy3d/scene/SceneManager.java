...
//		pickResults.setCheckDistance(true);
	...
	public boolean renderUnto(Renderer renderer) {
		if (dirtyRenderer) {
			renderer.setBackgroundColor(viewMode == ViewMode.PRINT_PREVIEW ? ColorRGBA.WHITE : ColorRGBA.BLACK);
			dirtyRenderer = false;
		}
...
//	}
	...
	public void print() {
		...
		for (HousePart part : Scene.getInstance().getPrintParts()) {
			...
			Vector3 pos = new Vector3(part.getPrintX() * scale, -5, part.getPrintY() * scale);
