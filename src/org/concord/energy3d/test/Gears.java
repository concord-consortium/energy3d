...
private final float view_rotz = 0.0f;
  ...
  public static void main(final String[] args) {
    ...
    final java.awt.Frame frame = new java.awt.Frame("Gear Demo");
    ...
    System.out.println("frame.add(canvas)");
...
public void init(final GLAutoDrawable drawable) {
    ...
    try {
		...
		final MouseListener gearsMouse = new GearsMouseAdapter();
		final KeyListener gearsKeys = new GearsKeyAdapter();
