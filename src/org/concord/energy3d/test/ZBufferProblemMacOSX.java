...
maxHeapMemory = 64)
public class ZBufferProblemMacOSX implements Scene {
    ...
    public static void main(final String[] args) {
        final ZBufferProblemMacOSX example = new ZBufferProblemMacOSX();
        example.start();
    }
    ...
    private void initExample() {
        ...
        // Make a box...
        final Box _box = new Box("Box", Vector3.ZERO, 50, 50, 1);
        ...
        // Make a box...
        final Box _box2 = new Box("Box", Vector3.ZERO, 50, 50, 1);

        // Make it a bit more colorful.
//        _box2.setRandomColors();

        // Setup a bounding box for it.
        _box2.setModelBound(new BoundingBox());

        // Set its location in space.
        _box2.setTranslation(new Vector3(0, 0, -15.5));
...
//                    ZBufferProblemMacOSX.class, "com/ardor3d/example/media/"));
...
//        _box.setRenderState(ts);
	...
	public boolean renderUnto(final Renderer renderer) {
    	Camera.getCurrentCamera().setLocation(0, 0, 900);
        if (!_canvas.isClosing()) {
